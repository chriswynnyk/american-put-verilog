...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone II" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=14 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 clock dataa datab result
...
module  fp_add_v1_altbarrel_shift_k0e
	...
	assign
		...
		sel_w = {distance[5:0]};
endmodule //fp_add_v1_altbarrel_shift_k0e
...
endmodule //fp_add_v1_altbarrel_shift_q3g
...
//synthesis_resources = lpm_add_sub 15 lpm_compare 1 reg 1179 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_v1_altfp_add_sub_d3j
	( 
	clock,
	dataa,
	datab,
	...
	fp_add_v1_altbarrel_shift_k0e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_add_v1_altbarrel_shift_q3g   rbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fp_add_v1_altfp_add_sub_d3j
//VALID FILE
...
module fp_add_v1 (
	...
	fp_add_v1_altfp_add_sub_d3j	fp_add_v1_altfp_add_sub_d3j_component (
				.dataa (dataa),
				.datab (datab),
				.clock (clock),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_add_v1_inst.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_add_v1_bb.v TRUE FALSE
