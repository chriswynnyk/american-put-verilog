...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone II" DIRECTION="SUB" OPTIMIZE="SPEED" PIPELINE=10 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 clk_en clock dataa datab result
...
module  fp_sub_altbarrel_shift_k0e
	...
	assign
		...
		sel_w = {distance[5:0]};
endmodule //fp_sub_altbarrel_shift_k0e
...
endmodule //fp_sub_altbarrel_shift_9hb
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_sub_altfp_add_sub_moj
	( 
	clk_en,
	clock,
	dataa,
	...
	fp_sub_altbarrel_shift_k0e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_sub_altbarrel_shift_9hb   rbarrel_shift
	( 
...
endmodule //fp_sub_altfp_add_sub_moj
//VALID FILE
...
module fp_sub (
	...
	fp_sub_altfp_add_sub_moj	fp_sub_altfp_add_sub_moj_component (
				.dataa (dataa),
				.datab (datab),
				.clk_en (clk_en),
				.clock (clock),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_sub_inst.v TRUE FALSE
