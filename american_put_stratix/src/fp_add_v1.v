...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix III" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=14 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 clock dataa datab result
//VERSION_BEGIN 8.1 cbx_altbarrel_shift 2008:05:19:10:20:21:SJ cbx_altfp_add_sub 2008:08:08:01:02:36:SJ cbx_altpriority_encoder 2008:05:19:11:01:44:SJ cbx_cycloneii 2008:05:19:10:57:37:SJ cbx_lpm_add_sub 2008:05:19:10:49:01:SJ cbx_lpm_compare 2008:09:01:07:44:05:SJ cbx_mgl 2008:08:08:15:16:18:SJ cbx_stratix 2008:08:05:17:10:23:SJ cbx_stratixii 2008:08:07:13:54:47:SJ  VERSION_END
// synthesis VERILOG_INPUT_VERSION VERILOG_2001
// altera message_off 10463



//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix III" PIPELINE=1 SHIFTDIR="LEFT" WIDTH=55 WIDTHDIST=6 aclr clk_en clock data distance result
...
module  fp_add_v1_altbarrel_shift_v4e
	...
	assign
		...
		sel_w = {distance[5:0]};
endmodule //fp_add_v1_altbarrel_shift_v4e


//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix III" PIPELINE=1 REGISTER_OUTPUT="NO" SHIFTDIR="RIGHT" WIDTH=55 WIDTHDIST=6 aclr clk_en clock data distance result
//VERSION_BEGIN 8.1 cbx_altbarrel_shift 2008:05:19:10:20:21:SJ cbx_mgl 2008:08:08:15:16:18:SJ  VERSION_END
...
endmodule //fp_add_v1_altbarrel_shift_58g
...
module  fp_add_v1_altpriority_encoder_3e8
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //fp_add_v1_altpriority_encoder_3e8
...
endmodule //fp_add_v1_altpriority_encoder_6e8
...
endmodule //fp_add_v1_altpriority_encoder_be8
...
endmodule //fp_add_v1_altpriority_encoder_rf8
...
module  fp_add_v1_altpriority_encoder_3v7
	...
	assign
		q = {data[1]};
endmodule //fp_add_v1_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_v1_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	fp_add_v1_altpriority_encoder_3v7   altpriority_encoder21
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder21_q));
	fp_add_v1_altpriority_encoder_3e8   altpriority_encoder22
	( 
	.data(data[3:2]),
...
endmodule //fp_add_v1_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_v1_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	fp_add_v1_altpriority_encoder_6v7   altpriority_encoder19
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder19_q));
	fp_add_v1_altpriority_encoder_6e8   altpriority_encoder20
	( 
	.data(data[7:4]),
...
endmodule //fp_add_v1_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_v1_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
...
endmodule //fp_add_v1_altpriority_encoder_r08

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_v1_altpriority_encoder_tv8
	( 
	data,
	q) ;
	input   [31:0]  data;
...
endmodule //fp_add_v1_altpriority_encoder_tv8
...
endmodule //fp_add_v1_altpriority_encoder_te9
...
endmodule //fp_add_v1_altpriority_encoder_uu8
...
module  fp_add_v1_altpriority_encoder_nh8
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //fp_add_v1_altpriority_encoder_nh8
...
endmodule //fp_add_v1_altpriority_encoder_qh8
...
endmodule //fp_add_v1_altpriority_encoder_vh8
...
endmodule //fp_add_v1_altpriority_encoder_fj8
...
endmodule //fp_add_v1_altpriority_encoder_hi9
...
module  fp_add_v1_altpriority_encoder_n28
	...
	assign
		q = {(~ data[0])};
endmodule //fp_add_v1_altpriority_encoder_n28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_v1_altpriority_encoder_q28
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	fp_add_v1_altpriority_encoder_nh8   altpriority_encoder41
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder41_q),
	.zero(wire_altpriority_encoder41_zero));
	fp_add_v1_altpriority_encoder_n28   altpriority_encoder42
	( 
	.data(data[3:2]),
...
endmodule //fp_add_v1_altpriority_encoder_q28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_v1_altpriority_encoder_v28
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	fp_add_v1_altpriority_encoder_qh8   altpriority_encoder39
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder39_q),
	.zero(wire_altpriority_encoder39_zero));
	fp_add_v1_altpriority_encoder_q28   altpriority_encoder40
	( 
	.data(data[7:4]),
...
endmodule //fp_add_v1_altpriority_encoder_v28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_v1_altpriority_encoder_f48
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	fp_add_v1_altpriority_encoder_vh8   altpriority_encoder37
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder37_q),
	.zero(wire_altpriority_encoder37_zero));
	fp_add_v1_altpriority_encoder_v28   altpriority_encoder38
	( 
	.data(data[15:8]),
...
endmodule //fp_add_v1_altpriority_encoder_f48

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_v1_altpriority_encoder_h39
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	fp_add_v1_altpriority_encoder_fj8   altpriority_encoder35
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder35_q),
	.zero(wire_altpriority_encoder35_zero));
	fp_add_v1_altpriority_encoder_f48   altpriority_encoder36
	( 
	.data(data[31:16]),
...
endmodule //fp_add_v1_altpriority_encoder_h39
...
endmodule //fp_add_v1_altpriority_encoder_ina

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 1408 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
endmodule //fp_add_v1_altfp_add_sub_o7j
//VALID FILE
...
module fp_add_v1 (
	...
	fp_add_v1_altfp_add_sub_o7j	fp_add_v1_altfp_add_sub_o7j_component (
				.dataa (dataa),
				.datab (datab),
				.clock (clock),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_add_v1.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_add_v1.inc FALSE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_add_v1.cmp FALSE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_add_v1.bsf FALSE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_add_v1_inst.v FALSE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_add_v1_bb.v FALSE FALSE
