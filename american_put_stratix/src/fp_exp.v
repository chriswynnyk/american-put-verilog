...
//altfp_exp CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix III" PIPELINE=25 ROUNDING="TO_NEAREST" WIDTH_EXP=11 WIDTH_MAN=52 clk_en clock data result
...
endmodule //fp_exp_altfp_exp_3cd
//VALID FILE
...
module fp_exp (
	...
	fp_exp_altfp_exp_3cd	fp_exp_altfp_exp_3cd_component (
				.clk_en (clk_en),
				.clock (clock),
				.data (data),
				.result (sub_wire0));
