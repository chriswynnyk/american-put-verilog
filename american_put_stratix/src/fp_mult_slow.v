...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix III" PIPELINE=5 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 clk_en clock dataa datab result
...
endmodule //fp_mult_slow_altfp_mult_28k
//VALID FILE
...
module fp_mult_slow (
	...
	fp_mult_slow_altfp_mult_28k	fp_mult_slow_altfp_mult_28k_component (
				.dataa (dataa),
				.datab (datab),
				.clk_en (clk_en),
				.clock (clock),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_mult_slow_inst.v FALSE
