...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix III" PIPELINE=11 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 clock dataa datab result
...
endmodule //fp_mult_v1_altfp_mult_3lj
//VALID FILE
...
module fp_mult_v1 (
	...
	fp_mult_v1_altfp_mult_3lj	fp_mult_v1_altfp_mult_3lj_component (
				.dataa (dataa),
				.datab (datab),
				.clock (clock),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_mult_v1_inst.v FALSE
