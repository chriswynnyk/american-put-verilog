...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix III" DIRECTION="SUB" OPTIMIZE="SPEED" PIPELINE=10 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 clk_en clock dataa datab result
...
module  fp_sub_altbarrel_shift_v4e
	...
	assign
		...
		sel_w = {distance[5:0]};
endmodule //fp_sub_altbarrel_shift_v4e


//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix III" SHIFTDIR="RIGHT" WIDTH=55 WIDTHDIST=6 data distance result
//VERSION_BEGIN 8.1 cbx_altbarrel_shift 2008:05:19:10:20:21:SJ cbx_mgl 2008:08:08:15:16:18:SJ  VERSION_END
...
endmodule //fp_sub_altbarrel_shift_klb
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_sub_altpriority_encoder_tv8
	( 
	data,
	q) ;
	input   [31:0]  data;
...
endmodule //fp_sub_altpriority_encoder_tv8
...
endmodule //fp_sub_altpriority_encoder_te9
...
endmodule //fp_sub_altpriority_encoder_uu8
...
//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 917 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
endmodule //fp_sub_altfp_add_sub_1tj
//VALID FILE
...
module fp_sub (
	...
	fp_sub_altfp_add_sub_1tj	fp_sub_altfp_add_sub_1tj_component (
				.dataa (dataa),
				.datab (datab),
				.clk_en (clk_en),
				.clock (clock),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_sub.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_sub.inc FALSE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_sub.cmp FALSE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_sub.bsf FALSE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_sub_inst.v FALSE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_sub_bb.v FALSE FALSE
